...
class GraphSage(pyg_nn.MessagePassing):
    def __init__(self, in_channels, out_channels, reducer='mean',
        ...
        self.num_all_experts = 8  # 原来是4
        self.k_experts = 3   # 原来是4
        ...
        self.agg_lins = nn.ModuleList(
            [nn.Linear(in_channels + out_channels, out_channels) for i in range(self.num_all_experts)])
    ...
    def top_K(self, x, k):
        ...
        mask = -np.inf * torch.ones(x.shape)
